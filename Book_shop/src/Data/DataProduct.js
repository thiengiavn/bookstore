...
export default restaurantData = [
  {
    ...
    sales: true,
    like: false,
    nameProducts: 'Tự Học Ứng Dụng Di Truyền Học, Tiến Hóa Và Sinh Thái',
  ...
  },
  {
    ...
    sales: false,
    like: true,
    nameProducts: 'Chuyến Bay Tháng Ba',
  ...
  },
  {
    ...
    avatarImage: image.degiocuondi,
    description:
      'Để Gió Cuốn Đi là cuốn tự truyện không quá nhiều chất văn nhưng vô cùng hình tượng, không nhiều mỹ từ lấp lánh mà rất hấp dẫn, say mê, lôi cuốn lòng người bởi những dòng viết tuôn chảy từ trái tim - ộc mạc - chân thật - sau sắc - lắng đọng, trái ngược với vẻ đẹp kiêu sa, thánh thiện, ngời sáng nơi chị. Người đọc càng bất ngờ hơn khi hiểu được một người Nghệ sỹ tài sắc vẹn toàn, danh tiếng như chị lại có thể có những năm tháng trầm luân, khổ hạnh đến tuyệt vọng - tới mức không thể tin nổi như vậy! Nhưng thật bất ngờ và thú vị - điểm khác biệt nổi bật nhất – so với tất cả những cuốn tự truyện khác - ở Việt Nam, và ngay cả trên thế giới - được bạn đọc quan tâm nhất lại không phải là những trang sách có chữ - mà là những trang sách bị xóa trắng trên nền biển bão tố, bắt đầu từ trang 242 và kết thúc ở trang 248 với hình nền cơn lốc xoáy để bắt đầu phần 15 – VƯỢT BIÊN. ',
    price: 151000,
    author: 'Ái Vân',
  },
  {
